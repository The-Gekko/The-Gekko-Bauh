...
class FlatpakTest(TestCase):
    ...
    @patch(f'{__package_name__}.gems.flatpak.flatpak.SimpleProcess')
    @patch(f'{__package_name__}.gems.flatpak.flatpak.ProcessHandler.handle_simple', return_value=(True, """
    Looking for updates...
