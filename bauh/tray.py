...
from bauh.context import disable_theme_watcher, new_qt_application
from bauh.view.qt.systray import TrayIcon


def new_tray_icon(app_config: dict, logger: Logger) -> Tuple[QApplication, QObject]:
    # la bandeja no vigila los ficheros de color: no merece la pena repintar todos sus widgets
    disable_theme_watcher()
